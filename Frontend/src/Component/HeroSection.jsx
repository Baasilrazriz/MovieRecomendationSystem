      ...
      <div className='flex flex-col justify-end h-full items-start'>
        <div className="z-10 p-8 text-white max-w-md">
          ...
          <div className="mt-4 space-x-2">
            ...
            {props.page==="home"? <button onClick={() => dispatch(openModal(props.movie))} className="bg-gradient-to-r from-gray-800 to-gray-600 text-white px-4 py-2 font-bold rounded hover:bg-gradient-to-r hover:from-gray-600 hover:to-gray-500">More Info</button>:<></>}  
          </div>
        </div>
      </div>
    </div>
